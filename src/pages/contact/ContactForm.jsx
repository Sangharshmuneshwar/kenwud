...
const ContactForm = () => {
  ...
  return (
    <>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      Ken Engineers India, Plot No B-40 / B-41 MIDC BUTIBORI
                      NAGPUR Maharastra India - 441122
                    </p>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <button
              ...
              className="mt-4 bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-dark"
            >
              Close
            </button>
          </div>
      ...
      <section className="px-4 md:px-14 py-8">
        <div className="max-w-full mx-auto text-center">
          <p className="text-2xl md:text-3xl font-semibold mb-4">Our Location:</p>
          <div className="overflow-hidden rounded-lg shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3742.7171694728894!2d78.958127!3d20.9315799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4972b193d4c5d%3A0x12dd5c113507f352!2sKEN%20ENGINEERS%20INDIA!5e0!3m2!1sen!2sin!4v1698242549203!5m2!1sen!2sin"
